...
//Help function to get the userid and the guest id
...
router.post("/",async(req,res) =>{
    ...
    try {
        ...
        //If the cart exist it need to updated
        if(cart){
...
router.put("/",async(req,res)=>{
    const {productId, quantity, price, color, guestId, size, userId} =req.body;
