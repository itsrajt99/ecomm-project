...
const ProductManagement = () => {
    ...
    const handleDelete = (id) =>{
      if(window.confirm("Are yu want to delete the product")) {
        console.log(id)
      }
    }
  return (
                   ...
                   products.map((product)=>(
                    <tr key={product._id} className='border-b hover:bg-gray-50 cursor-pointer'>
                        ...
                        <td className="p-4">
                            ...
                            >Edit</Link>
                            <button className='bg-red-500 rounded px-1 py-1 text-white cursor-pointer hover:bg-red-700 ' onClick={()=>handleDelete(product._id)}>Delete</button>
                        </td>
                    </tr>
                   ))
                ) : (<tr>
