  ...
  return (
    <section className='py-16 px-4 lg:px-0'>
       <div className='container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-100 rounded-3xl'>
        {/* Left */}
        <div className="lg:w-1/2 p-8 text-center lg:trext-left">
         ...
         <Link to="/collections/all" className='bg-black text-white px-6 py-3 rounded-lg text-lg hpver:bg-gray-800'>SHOP NOW</Link>
        </div>
        {/* Right */}
