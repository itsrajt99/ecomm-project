            ...
            {categories.map((category)=>(
                <div key={category} className='flex items-center gap-2'>
                    <input 
                     ...
                     name='category' 
                     className='mb-1 h-4 text-blue-500 focus:ring-blue-400 border-gray-300 cursor-pointer' />
        ...
        <label htmlFor="" className="block text-gray-600 font-medium mb-2">Material</label>
         {materials.map((material)=>(
            <div key={material} className='flex items-center mb-1'>
                ...
                name="material"
                className='mr-2 h-4 w-4 accent-blue-500 focus:ring-blue-400 cursor-pointer border-gray-300'
                 />
